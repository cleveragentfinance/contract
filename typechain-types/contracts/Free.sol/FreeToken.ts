...
export interface FreeTokenInterface extends utils.Interface {
  functions: {
    ...
    "setLottery(address)": FunctionFragment;
  ...
  decodeFunctionResult(functionFragment: "setLottery", data: BytesLike): Result;
...
export interface FreeToken extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FreeTokenInterface;
